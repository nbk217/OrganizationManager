    ...
    <tbody>
        <tr>
         ...
         <tr>
                ...
                <td><a  href="/requirements-entity?id=${entity.id}" class ="btn btn-secondary">Requirements</a></td>
                <td><a  href="/ownership-entity?id=${entity.id}" class ="btn btn-secondary" href="/add-entity">Ownership</a></td>
